...
export const GymCard: React.FC<GymCardProps> = ({
  ...
  return (
    <div 
      id={`gym-card-${gym.id}`}
      className="bg-neutral-900 rounded-3xl overflow-hidden border border-neutral-800 shadow-md transition-all duration-300 hover:shadow-lg"
    >
      {/* Banner Image */}
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex justify-between items-start gap-2">
          ...
          <div className="flex items-center gap-1 bg-amber-500/10 border border-amber-500/20 px-1.5 py-0.5 rounded text-amber-400 font-bold text-xs shrink-0">
        ...
        <div className="flex items-start gap-1 text-[11px] text-neutral-400">
          <MapPin size={12} className="shrink-0 mt-0.5 text-neutral-500" />
        ...
        <div className="pt-2.5 border-t border-neutral-805 flex items-center justify-between gap-2">
          ...
          {isAccessible ? (
            <button
              ...
              className="bg-indigo-600 hover:bg-indigo-700 px-3 py-1.5 rounded-xl text-xs font-bold text-white transition-all shadow-sm hover:shadow active:scale-95 cursor-pointer"
            >
              Вхід по QR
            </button>
          ) : (
            <button
              ...
              className="bg-neutral-800 hover:bg-neutral-750 px-3 py-1.5 rounded-xl text-xs font-bold text-neutral-300 transition-all border border-neutral-750 cursor-pointer"
            >
              Підняти тариф
            </button>
          )}
